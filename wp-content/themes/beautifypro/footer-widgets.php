 ...
 * @package BeautifyPro
 */
$footer_widget_count = get_theme_mod('footer_widgets_count', 3 );
			...
			if( $i == 1 ) {
				if ( is_active_sidebar( 'footer' ) ) :
					...
					<aside id="meta" class="widget">
						<h4 class="widget-title"><?php _e( 'Meta', 'beautify_pro' ); ?></h4>
						<ul> 
							<?php wp_register(); ?>
				...
				if ( is_active_sidebar( 'footer-'.$i ) ) :
			        ...
			        <aside id="archives" class="widget">
						<h4 class="widget-title"><?php _e( 'Archives', 'beautify_pro' ); ?></h4>
						<ul>
