<?php
	/*
	This script is slightly modified version Kyle Getson's Sidebar Generator plugin.
	...
	*/
	 ...
	 * Since the plugin has not been updated for over 2 years
	 * many changes has been made by
	 * Author: N. Venkat Raj
	 *
	 * TODO: Still needs lots of improvement. Have to move all js to external file
	 * But, good start. :)
	 *
	 */

	class Fw_Sidebar_Generator {
		...
		public static function getInstance( ) {
			if( self::$instance === null) {
				self::$instance = new Fw_Sidebar_Generator();
			}
			return self::$instance;
		}

		/**
		 * Fw_Sidebar_Generator constructor.
		 */
		...
		public function admin_menu() {
			add_theme_page(
				...
				'Sidebars',
				'manage_options',
				'wbls_multiple_sidebars',
				array( $this, 'admin_page' )
			);
		}

		public function enqueue_scripts(){
		    wp_enqueue_script('sidebar_generator', get_template_directory_uri() . '/framework/admin/js/sidebar-generator.js', array('jquery'), '1.0.0', true );
		}
		...
		public function admin_page() {
			...
			<div class="wrap">
				...
				<div class="add_sidebar">
					<a href="#" id="generate_sidebar" title="Add a sidebar"
					   class="button-primary">+ Add Sidebar</a>
				</div>
				<br/>
						...
						if ( is_array( $sidebars ) && ! empty( $sidebars ) ) {
							...
							foreach ( $sidebars as $sidebar ) {
								...
								<tr class="<?php echo $alt ?>">
									...
									<td><a href="#" class="remove_sidebar"
									       data-sidebar-name="<?php echo $sidebar; ?>"
									       data-sidebar-count="<?php echo $cnt + 1; ?>"
			...
			if ( in_array( $post->post_type, array( 'post', 'page' ) ) ) {
				...
				<div id='sbg-sortables' class='meta-box-sortables'>
					<div id="sbg_box" class="postbox ">
						...
						<h3 class='hndle'><span>Sidebars</span></h3>
						...
						<div class="inside">
							<div class="sbg_container">
								...
								<p>
									Select the sidebar you wish to display on this page. <br/>
									<strong>Note:</strong> You must first create the sidebar under Appearance >
									Sidebars.
								</p>
								<ul>
									<?php
	...
	function generated_dynamic_sidebar($name='0'){
		Fw_Sidebar_Generator::get_sidebar($name);
		return true;
	}
