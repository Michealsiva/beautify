<?php if( $instance['design']['theme'] == 'normal') {
          $social_class  = 'theme-social-network';
	}?>
<div class="social-media-button-container <?php echo $social_class; ?>">
	<?php foreach( $networks as $network ) :
		...
		$button_attributes = array(
			...
			'title' => sprintf( __( '%s on %s', 'framework' ), get_bloginfo( 'name' ), ucwords( str_replace( '-', ' ', $network['name'] ) ) ),
		);
